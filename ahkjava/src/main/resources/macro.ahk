...
Gui, 2:Add, Text,x5 h20 c2959a5, Dx11 (x64) Client:
...
;Bottom Section (ew)
Gui, 2:Add, Text, xm, Questions/Comments: Ingame:@Lutcikaur Reddit:/u/lutcikaur
...
Gui, 6:Add, Text,x7 y7, Your settings are incorrect. Please have marks in the correct boxes if you are running on steam / with dx11
Gui, 6:Add, Text,x7 y25 vbackupErrorFound, Your settings are incorrect. Please have marks in the correct boxes if you are running on steam / with dx11
Gui, 6:Add, Text,x7 y43 vbackupErrorExpected, Your settings are incorrect. Please have marks in the correct boxes if you are running on steam / with dx11
...
submit(){  
	...
	updsettings .= "WAXOffset=" . guiWAXOffset . "`n"
	updsettings .= "WAYOffset=" . guiWAYOffset . "`n"
	...
	updsettings .= "Scroll=" . guiscroll . "`n"
	updsettings .= "HighBits=" . guihighBits . "`n"
	updsettings .= "Diablo2=" . guidiablo2 . "`n"
	updsettings .= "duration1=" . guiduration1 . "`n"
	updsettings .= "duration2=" . guiduration2 . "`n"
	updsettings .= "duration3=" . guiduration3 . "`n"
	updsettings .= "duration4=" . guiduration4 . "`n"
	updsettings .= "duration5=" . guiduration5 . "`n"
	updsettings .= "duration6=" . guiduration6 . "`n"
	updsettings .= "duration7=" . guiduration7 . "`n"
	updsettings .= "cooldownColor1=" . guicooldownColor1 . "`n"
	updsettings .= "cooldownColor2=" . guicooldownColor2 . "`n"
	updsettings .= "cooldownColor3=" . guicooldownColor3 . "`n"
	updsettings .= "cooldownColor4=" . guicooldownColor4 . "`n"
	updsettings .= "cooldownColor5=" . guicooldownColor5 . "`n"
	updsettings .= "cooldownColor6=" . guicooldownColor6 . "`n"
	updsettings .= "cooldownColor7=" . guicooldownColor7 . "`n"
	...
	updsettings .= "kick=" . guihotkeyKick . "`n"
	...
	updsettings .= "cooldown1=" . guihotkeyCooldown1 . "`n"
	updsettings .= "cooldown2=" . guihotkeyCooldown2 . "`n"
	updsettings .= "cooldown3=" . guihotkeyCooldown3 . "`n"
	updsettings .= "cooldown4=" . guihotkeyCooldown4 . "`n"
	updsettings .= "cooldown5=" . guihotkeyCooldown5 . "`n"
	updsettings .= "cooldown6=" . guihotkeyCooldown6 . "`n"
	updsettings .= "cooldown7=" . guihotkeyCooldown7 . "`n"
